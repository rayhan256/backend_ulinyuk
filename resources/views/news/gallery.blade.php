                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Form Tambah Gambar Berita</h5>
                        ...
                        <div class="ibox-content">
                            <form action="{{ url('/tambah-galeri') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="id_berita" value="{{$galeri->id == null ? '' : $galeri->id}}">
                                    </div>
                                    <div class="hr-line-dashed"></div>

                                    <label class="col-sm-2 col-form-label">Gambar Berita</label>
                                    <div class="col-sm-10">
                                        <input id="gambar" name="foto_berita" type="file" class="form-control">
                                    </div>
