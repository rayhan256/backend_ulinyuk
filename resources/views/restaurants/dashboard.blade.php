    ...
    <div id="wrapper">
        ...
        <div class="row wrapper white-bg page-heading">
            ...
            <div class="col-lg-2">
                <div class="col mt-3">
                    <center>
                    <a href="/restaurant-add-data" class="btn btn-lg btn-primary">Add <i class="fa fa-plus"></i></a>
                    </center>
                </div>
                <br>
                <center>
                        ...
                        <div class="ibox-content product-box">
                            ...
                            <div class="product-desc">
                                ...
                                <div class="m-t text-righ">
                                    ...
                                    <a href="/restaurant-detail" class="btn btn-xs btn-outline btn-primary">Info <i
                    ...
                    <div class="ibox">
                        <div class="ibox-content product-box">
                            ...
                            <div class="product-desc">
                                ...
                                <a href="/restaurant-detail" class="product-name"> Restaurant B</a>
                                <div class="small m-t-xs">
                                    Many desktop publishing packages and web page editors now.
                                </div>
                                <div class="m-t text-righ">
                    ...
                    <div class="ibox">
                        <div class="ibox-content product-box">
                            ...
                            <div class="product-desc">
                                ...
                                <a href="/restaurant-detail" class="product-name"> Restaurant C</a>
                                <div class="small m-t-xs">
                                    Many desktop publishing packages and web page editors now.
                                </div>
                                <div class="m-t text-righ">
                    ...
                    <div class="ibox">
                        <div class="ibox-content product-box">
                            ...
                            <div class="product-desc">
                                ...
                                <a href="/restaurant-detail" class="product-name"> Restaurant D</a>
                                <div class="small m-t-xs">
                                    Many desktop publishing packages and web page editors now.
                                </div>
                                <div class="m-t text-righ">
