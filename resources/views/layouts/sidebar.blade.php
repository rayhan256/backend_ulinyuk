<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li>
                <a href="/restaurants"><i class="fa fa-cutlery"></i> <span class="nav-label">Restaurants</span></a>
            </li>
            <li>
                <a href="/destinations"><i class="fa fa-tree"></i> <span class="nav-label">Destinations</span></a>
            </li>
