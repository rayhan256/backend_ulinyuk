            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-md-2">
                    ...
                    <div style="float: right">
                        <a href="/destination-detail" class="btn btn-sm btn-outline btn-primary"> <i
                        ...
                        <div class="ibox-content">
                            <form method="get">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" placeholder="ID Galeri objek wisata" class="form-control">
                                    </div>
                                    <div class="hr-line-dashed"></div>

                                    <label class="col-sm-2 col-form-label">ID Objek Wisata</label>
                                    <div class="col-sm-10">
                                        <input type="text" placeholder="ID objek wisata" class="form-control">
                                    </div>
                                    <div class="hr-line-dashed"></div>
