...
class ModelHotelDetails extends Model
{
    ...
    protected $fillable = [
        'id_kategori_kamar_hotel', 'id_hotel', 'kategori_kamar_hotel', 'harga_kamar_hotel', 'jadwal_checkin_hotel', 'jadwal_checkout_hotel', 'fasilitas_hotel', 'fasilitas_kamar_hotel', 'fasilitas_publik_hotel', 'fasilitas_terdekat_hotel', 'fasilitas_transportasi_hotel', 'deskripsi_hotel'
    ];
