...
class ModelHistoriBookingHotels extends Model
{
    ...
    protected $fillable = [
        'id_booking_kamar', 'id_user', 'id_booking_kamar', 'id_kategori_kamar_hotel', 'id_hotel', 'jumlah_booking_kamar', 'tanggal_checkin', 'tanggal_checkout', 'lama_inap', 'total_bayar'
    ];
