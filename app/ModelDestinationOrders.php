...
class ModelDestinationOrders extends Model
{
    ...
    protected $fillable = [
        'id_user', 'id_kategori_objek_wisata', 'id_objek_wisata', 'tanggal_booking_tiket', 'harga_tiket', 'jumlah_booking_tiket', 'total_bayar'
    ];
    ...
    {
        return $this->belongsTo(ModelDestinationDetails::class, 'id_kategori_objek_wisata', 'id');
    }
}
